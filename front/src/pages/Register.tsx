...
export default function Register() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] px-4 pb-20 pt-10">
            <Card className="w-full max-w-xl rounded-[2.5rem] shadow-2xl shadow-blue-900/5 border border-gray-100 relative p-4 sm:p-6 bg-white">
                    ...
                    <form onSubmit={handleRegister} className="space-y-5">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-2.5">
                                <Label htmlFor="firstName" className="text-sm font-bold text-gray-600 ml-1">First Name</Label>
                                <Input id="firstName" placeholder="John" value={firstName}
                                    onChange={(e) => setFirstName(e.target.value)} required
                                    className="h-14 text-base bg-gray-50 border-gray-200 rounded-xl focus-visible:ring-[#134c9c]" />
                            </div>
                            <div className="space-y-2.5">
                                <Label htmlFor="lastName" className="text-sm font-bold text-gray-600 ml-1">Last Name</Label>
                        ...
                        <div className="space-y-2.5">
                            ...
                            <Input id="email" type="email" placeholder="name@example.com" value={email}
                                ...
                                className={`h-14 text-base rounded-xl focus-visible:ring-[#134c9c] transition-colors ${
                                    touchedEmail && !isEmailValid ? "bg-red-50 border-red-300 text-red-900" : "bg-gray-50 border-gray-200"
                                }`}
                            />
                        ...
                        {/* TELEFON */}
                        <div className="space-y-2.5">
                            <Label htmlFor="phone" className="text-sm font-bold text-gray-600 ml-1">Phone Number</Label>
                            <Input id="phone" type="tel" required placeholder="0712 345 678" value={phoneNumber}
                                ...
                                className={`h-14 text-base rounded-xl focus-visible:ring-[#134c9c] transition-colors ${
                                    touchedPhone && !isPhoneValid ? "bg-red-50 border-red-300 text-red-900" : "bg-gray-50 border-gray-200"
                                }`}
                            />
                        ...
                        <div className="space-y-2.5">
                            ...
                            <Input id="password" type="password" placeholder="Minimum 8 characters" value={password} required
                                ...
                                className={`h-14 text-base rounded-xl focus-visible:ring-[#134c9c] transition-colors ${
                                    touchedPassword && password.length < 8 ? "bg-red-50 border-red-300 text-red-900" : "bg-gray-50 border-gray-200"
                                }`}
                            />
                        ...
                        {/* CONFIRMARE PAROLA */}
                        <div className="space-y-2.5">
                            <Label htmlFor="confirmPassword" className="text-sm font-bold text-gray-600 ml-1">Confirm Password</Label>
                            <Input id="confirmPassword" type="password" placeholder="Repeat password" value={confirmPassword} required
                                onChange={(e) => setConfirmPassword(e.target.value)}
                                className={`h-14 text-base rounded-xl focus-visible:ring-[#134c9c] transition-colors ${
                                    confirmPassword && !passwordsMatch ? "bg-red-50 border-red-300 text-red-900" : "bg-gray-50 border-gray-200"
                                }`} 
                            />
                        ...
                        {/* Server Error */}
                        {serverError && (
                            <div className="bg-red-50 border border-red-100 text-red-600 px-4 py-3 rounded-2xl flex items-center justify-center gap-2 animate-in fade-in">
                ...
                <CardFooter className="flex justify-center pb-4 pt-2">
                    <p className="text-sm font-medium text-gray-500">Already have an account?
