                    ...
                    <form onSubmit={handleRegister} className="space-y-5">
                        ...
                        <div className="space-y-2.5">
                            ...
                            <Input id="email" type="email" placeholder="name@example.com" value={email}
                                ...
                                className={`h-14 text-base backdrop-blur-sm rounded-xl focus-visible:ring-[#134c9c] focus:bg-white transition-colors ${touchedEmail && !isEmailValid ? "bg-red-50/80 border-red-300 text-red-900" : "bg-white/60 border-white/50"
                                    }`}
                            />
                        ...
                        <div className="space-y-2.5">
                            ...
                            <Input id="phone" type="tel" required placeholder="0712 345 678" value={phoneNumber}
                                ...
                                className={`h-14 text-base backdrop-blur-sm rounded-xl focus-visible:ring-[#134c9c] focus:bg-white transition-colors ${touchedPhone && !isPhoneValid ? "bg-red-50/80 border-red-300 text-red-900" : "bg-white/60 border-white/50"
                                    }`}
                            />
                        ...
                        <div className="space-y-2.5">
                            ...
                            <div className="relative">
                                <Input id="password" type={showPassword ? "text" : "password"} placeholder="Minimum 8 characters" value={password} required
                                    onChange={(e) => setPassword(e.target.value)}
                                    onBlur={() => setTouchedPassword(true)}
                                    className={`h-14 text-base pr-12 backdrop-blur-sm rounded-xl focus-visible:ring-[#134c9c] focus:bg-white transition-colors ${touchedPassword && password.length < 8 ? "bg-red-50/80 border-red-300 text-red-900" : "bg-white/60 border-white/50"
                                        }`}
                                />
                        ...
                        <div className="space-y-2.5">
                            ...
                            <div className="relative">
                                <Input id="confirmPassword" type={showConfirmPassword ? "text" : "password"} placeholder="Repeat password" value={confirmPassword} required
                                    onChange={(e) => setConfirmPassword(e.target.value)}
                                    className={`h-14 text-base pr-12 backdrop-blur-sm rounded-xl focus-visible:ring-[#134c9c] focus:bg-white transition-colors ${confirmPassword && !passwordsMatch ? "bg-red-50/80 border-red-300 text-red-900" : "bg-white/60 border-white/50"
                                        }`}
                                />
                        ...
                        <Button disabled={!isValid || isLoading} type="submit"
                            className={`w-full h-14 rounded-2xl font-black text-lg mt-6 transition-all duration-300 ${isValid
