                                                ...
                                                <div className="p-6 sm:px-8">
                                                    ...
                                                    [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-gray-300">
                                                        {order.items.map((item) => {
                                                            ...
                                                            return (
                                                                <div key={item.id} className="flex items-center justify-between gap-4 p-3 rounded-2xl border border-gray-100/80 bg-gray-50/50 hover:bg-gray-50 transition-colors shadow-sm">
